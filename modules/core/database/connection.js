  ...
  async initialize(config = {}) {
    try {
      const dbConfig = {
        ...
        max: config.max || 20,
        // Shorter idle timeout so idle clients are recycled proactively
        idleTimeoutMillis: config.idleTimeoutMillis || 15000,
        connectionTimeoutMillis: config.connectionTimeoutMillis || 5000,
        // Enable TCP keepalive to avoid idle disconnects in managed networks
        ...
        // Reasonable client/server timeouts
